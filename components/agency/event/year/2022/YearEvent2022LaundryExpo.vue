<template>
    <div>
        <div class="accordion-item border-0 " style="background: transparent;">
                    <h2 class="accordion-header" id="flush-headingTwoOneX">
                      <button data-bs-collapse-init class="accordion-button collapsed text-black" type="button" data-bs-toggle="collapse"
                        data-bs-target="#flush-collapseTwoOneX" aria-expanded="false" aria-controls="flush-collapseTwoOneX" style="background: transparent;">
                        <h4 editable="inline" class="mb-0 Roboto text-uppercase"><b>{{ $t('AgencyEventTahun2022Event1') }}</b></h4>
                      </button>
                    </h2>
                    <div id="flush-collapseTwoOneX" class="accordion-collapse collapse" aria-labelledby="flush-headingTwoOneX"
                      data-bs-parent="#accordionFlushExampleXX22">
